...
object PluginSettings : SettingsHolder
{
    ...
    @JvmField
    @Comment("Set the group where new world created on the fly will be added")
    var DEFAULT_GROUP: Property<String>? = newProperty("default-group", "default")

    @JvmField
    @Comment("Prefix of autogenerated world", "such as DungeonXL", "exemple: DXL_Game_")
    var AUTO_GENERATED_WORLD_PREFIX: Property<String>? = newProperty("auto-generated-world-prefix", "")
}
